package com.rabo.custstatement.CustStatementProcessor;
...
public class CustStatementProcessorApplicationTests {
	...
	@Test
	public void uniqueReferencewithEndBalanceTest() {
		List<Fields> actual = customerStatementValidationServiceImpl.getBalanceDiscrepancyData(realTimeData());
		assert(actual.isEmpty());
	}
	@Test
	public void uniqueReferenceDataTest() {
		List<Fields> actual = customerStatementValidationServiceImpl.getduplicateData(realTimeData());
		assert(actual.isEmpty());
	}
}
